...
// ============================================================================
// Gemini API anahtarınızı aşağıya doğrudan yazabilir veya process.env.EXPO_PUBLIC_GEMINI_API_KEY kullanabilirsiniz.
...
export default function App() {
      ...
      <SafeAreaView style={styles.permissionContainer}>
        ...
        <View style={styles.permissionCard}>
          ...
          <Text style={styles.permissionText}>
            Matematik ve geometri sorularını tatarak hızlıca çözebilmek için uygulamanın kameraya erişmesine izin vermelisiniz.
          </Text>
  ...
  const solveWithGemini = async () => {
    ...
    try {
      // Gemini 1.5 Flash / 2.5 Flash modelini başlatıyoruz
...

{
  ...
  "teacherTip": "Öğrenciye sınav taktiği veya püf noktası"
      ...
      // JSON formatını temizleme (Markdown kod blokları temizlenir)
